...
// Source: github.com/isaki-kaji/nijimas-api/domain (interfaces: UserService)
...
func (m *MockUserService) CreateUser(arg0 context.Context, arg1 domain.CreateUserRequest) (db.User, error) {
	m.ctrl.T.Helper()
