...
type Querier interface {
	...
	CreateUserTopSubCategories(ctx context.Context, arg CreateUserTopSubCategoriesParams) ([]UserTopSubcategory, error)
	...
	GetUserUsedSubCategories(ctx context.Context, uid string) ([]GetUserUsedSubCategoriesRow, error)
