...
mockuserservice:
	mockgen -package mockservice  -destination application/service/mock/user_service.go  github.com/isaki-kaji/nijimas-api/application/service UserService

mockpostservice:
	mockgen -package mockservice  -destination application/service/mock/post_service.go  github.com/isaki-kaji/nijimas-api/application/service PostService
